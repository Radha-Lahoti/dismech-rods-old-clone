 ...
 * @author Radha Lahoti
 * @brief This is the file with all input parameters which the user can change according to the requirement
 * @version 0.1
 * @date 2024-01-11
 * 
...
/**
 * @brief struct to store all user defined input parameters
 * 
 */
struct simParams {
...
/**
 * @brief Get the robot description
 * 
 * @param argc 
 * @param argv 
 * @param soft_robots the soft robot object
 * @param forces force container
 * @param logger logger
 * @param sim_params simulation input parameters
 */
